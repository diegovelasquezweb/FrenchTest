...
interface OrthographeQuizState {
  phase: QuizPhase;
...
const initialState: OrthographeQuizState = {
...
function reducer(state: OrthographeQuizState, action: OrthographeAction): OrthographeQuizState {
  switch (action.type) {
    case "HOME":
      return { ...initialState };
    case "START":
...
export interface UseOrthographeQuizReturn {
  state: OrthographeQuizState;
  startQuiz(): void;
...
export function useOrthographeQuiz(): UseOrthographeQuizReturn {
